...
"\n" + "Η τιμή του αρχικού κεφαλαίου της επόμενης διαχειριστικής χρήσης είναι:", tel, "ευρώ")
    elif x > 0:
        print ("Κέρδος:", x, "ευρώ")
    elif x < 0:
        print ("Ζημιά:", x, "ευρώ")
    ...
    if tel < 0:
        print ("Η τιμή του τελικού κεφαλαίου είναι αρνητική."
"\n" + "Η τιμή του αρχικού κεφάλαίου της επόμενης διαχειριστικής χρήσης είναι:", tel, "ευρώ")
    elif x > 0:
        print ("Κέρδος:", x, "ευρώ")
    elif x < 0:
        print ("Ζημιά:", x, "ευρώ")
